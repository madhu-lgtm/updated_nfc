...
writable_block_list_contents = [block_1, block_2, block_4, block_5, block_6, block_8, block_9, block_10, block_12, block_16, block_17, block_18, block_40, block_41, block_42, block_44, block_45]
writable_block_list_index = [1,2,4,5,6,8,9,10,12,16,17,18,40,41,42,44,45] 
...
if uid:
    ...
    #Compute Checksum
    checksum = hashlib.sha256(data).digest()      # raw 32-byte digest
    checksum_hex = checksum.hex() #to print
    ...
    try:
        ...
        print("VERIFICATION PASSED - Signature is VALID!")
    except:
        print("VERIFICATION FAILED!")
    
    # Split into your NFC blocks (pad if needed)
    sig_padded = signature.ljust(80, b'\x00')  # Pad to 80 bytes
    block_40 = sig_padded[0:16]
    block_41 = sig_padded[16:32]
    block_42 = sig_padded[32:48]
    block_44 = sig_padded[48:64]
    block_45 = sig_padded[64:80]

    # Now update your writable_block_list_contents with these real signatures
    writable_block_list_contents[-5:] = [block_40, block_41, block_42, block_44, block_45]
